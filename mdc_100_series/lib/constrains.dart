...
class Example3 extends Example {
  ...
  @override
  final String explanation = 'The screen forces the Center to be exactly the same size as the screen, '
...
class Example4 extends Example {
  ...
  final code = 'Align(\n'
      ...
      '   child: Container(width: 100, height: 100, color: red))';
  @override
  final String explanation = 'This is different from the previous example in that it uses Align instead of Center.'
      '\n\n'
...
class Example10 extends Example {
  ...
  final code = 'Center(\n'
      ...
      '        child: Container(color: red, width: 10, height: 10))))';
  @override
  final String explanation = 'Now, Center allows ConstrainedBox to be any size up to the screen size.'
      '\n\n'
...
class Example13 extends Example {
  ...
  @override
  final String explanation = 'The screen forces the UnconstrainedBox to be exactly the same size as the screen.'
...
class Example15 extends Example {
  ...
  final code = 'OverflowBox(\n'
      ...
      '   child: Container(color: red, width: 4000, height: 50));';
  @override
  final String explanation = 'The screen forces the OverflowBox to be exactly the same size as the screen, '
...
class Example18 extends Example {
  ...
  @override
  final String explanation = 'The screen forces the FittedBox to be exactly the same size as the screen.'
...
class Example22 extends Example {
  ...
  @override
  final String explanation = 'FittedBox can only scale a widget that is BOUNDED (has non-infinite width and height).'
...
class Example28 extends Example {
  ...
  @override
  final String explanation = 'The screen forces the Scaffold to be exactly the same size as the screen, '
...
class Example29 extends Example {
  ...
  @override
  final String explanation = 'If you want the Scaffold\'s child to be exactly the same size as the Scaffold itself, '
